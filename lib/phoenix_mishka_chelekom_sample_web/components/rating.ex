defmodule PhoenixMishkaChelekomSampleWeb.Components.Rating do
  @moduledoc """
  The `PhoenixMishkaChelekomSampleWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
