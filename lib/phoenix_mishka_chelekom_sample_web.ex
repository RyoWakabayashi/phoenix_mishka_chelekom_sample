defmodule PhoenixMishkaChelekomSampleWeb do
  ...
  This can be used in your application as:
      ...
      use PhoenixMishkaChelekomSampleWeb, :controller
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: PhoenixMishkaChelekomSampleWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {PhoenixMishkaChelekomSampleWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: PhoenixMishkaChelekomSampleWeb.Endpoint,
        router: PhoenixMishkaChelekomSampleWeb.Router,
        statics: PhoenixMishkaChelekomSampleWeb.static_paths()
    end
  end
